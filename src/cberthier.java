        ...
        perso.put("Mission", br2.readLine());
          ...
          while ((line=br2.readLine())!=null){
            ...
            BufferedReader br3 = new BufferedReader(persoTemplate);
             ...
             persoHtml = persoHtml.replace("var_carte", "C:\\Users\\Aurélien\\eclipse-workspace\\Go-Securi\\cberthier.jpg");
             
             System.out.println(persoHtml);
             
             //Creation HTML CHANGER NOM
             
             Path pathberthierHtml = Paths.get("C:\\Users\\Aurélien\\eclipse-workspace\\Go-Securi\\cberthier.html");
